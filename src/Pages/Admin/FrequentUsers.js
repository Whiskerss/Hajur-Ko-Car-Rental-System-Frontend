...
export default function FrequentUsers() {
    ...
    const getUsers = async () => {
        try {
            const response = await axiosInstance.get(`https://localhost:7013/api/user/frequent-user`);
    ...
    return (
        <div>
            ...
            {!error && users.length === 0 ? (<h4 className='text-center mt-5'>Oh No! No Frequently Active Users.</h4>) :
